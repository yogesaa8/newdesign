...
const JobCard = ({ job }) => (
  <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition duration-300 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    <div className="flex items-start gap-4 w-full md:w-auto">
      <div className="w-14 h-14 bg-gray-50 rounded-lg flex items-center justify-center flex-shrink-0 border border-gray-100">
    ...
    <div className="flex flex-col items-end justify-between w-full md:w-auto h-full gap-2 self-center">
      <div className="flex items-center gap-2 text-gray-500 text-sm font-medium mb-2 md:mb-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <BookmarkIcon />
        <Link to={`/jobs/${job.id}`} state={{ job, allJobs: jobsData }} className="bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition">
          Apply Now
        </Link>
      </div>
    </div>
...
const TopCompanyCard = ({ company }) => (
  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:border-blue-200 transition">
    <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-3 text-2xl font-bold text-gray-700">
      {company.logo}
    </div>
      ...
      <main className="grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 lg:w-1/4">
            <aside className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <select
                    id="location"
                    className="w-full pl-4 pr-10 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm appearance-none bg-white"
                  >
              ...
              <button className="w-full mt-8 bg-primary text-white py-2.5 rounded-lg font-medium shadow-md shadow-blue-200 hover:bg-blue-700 transition">
                Find Jobs
              </button>
            </aside>
          </div>
          ...
          <div className="w-full md:w-2/3 lg:w-3/4">
            ...
            <div className="mt-8 flex justify-center">
              <button className="flex items-center px-6 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-400 transition">
        ...
        <div className="mt-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-gray-900">Top Company</h2>
