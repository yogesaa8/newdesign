...
import { profileData } from "../../../json/mockData";
...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded-2xl border border-outline-variant bg-white shadow-sm dark:border-outline-variant/30 dark:bg-inverse-surface">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-on-surface dark:text-white">
              {profile.name}
            </h3>
            <p className="font-medium text-outline">{profile.position}</p>

            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-outline-variant py-2.5 shadow-1 dark:border-outline-variant/30 dark:bg-on-surface-variant/20">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-outline-variant px-4 dark:border-outline-variant/30 xsm:flex-row">
                <span className="font-semibold text-on-surface dark:text-white">
                  5+
                </span>
                <span className="text-sm text-outline">Exp</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-outline-variant px-4 dark:border-outline-variant/30 xsm:flex-row">
                <span className="font-semibold text-on-surface dark:text-white">
                  {profile.applications?.length || 42}
                </span>
                <span className="text-sm text-outline">Apps</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-semibold text-on-surface dark:text-white">
                  {profile.completion}%
                </span>
                <span className="text-sm text-outline">Done</span>
              </div>
            </div>

            <div className="mx-auto max-w-180">
              <h4 className="font-semibold text-on-surface dark:text-white">
                About Me
              </h4>
              <p className="mt-4.5 text-on-surface-variant">{profile.bio}</p>
            </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-outline-variant bg-white shadow-sm dark:border-outline-variant/30 dark:bg-inverse-surface">
          <div className="border-b border-outline-variant py-4 px-7 dark:border-outline-variant/30 flex justify-between items-center">
          ...
          <div className="p-7">
            <div className="grid grid-cols-2 gap-y-4 gap-x-6">
              <div>
                ...
                <p className="text-on-surface-variant mt-1">{profile.personalDetails.dob}</p>
              </div>
              <div>
                <label className="text-xs font-semibold text-outline uppercase tracking-wider">
                  Gender
        ...
        {/* Projects */}
        <div className="col-span-1 lg:col-span-2 rounded-2xl border border-outline-variant bg-white shadow-sm dark:border-outline-variant/30 dark:bg-inverse-surface">
          <div className="border-b border-outline-variant py-4 px-7 dark:border-outline-variant/30 flex justify-between items-center">
            <h3 className="font-medium text-on-surface dark:text-white flex items-center gap-2">
          ...
          <div className="p-7">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {profile.projects.map((proj) => (
                <div
                  key={proj.id}
                  className="p-5 rounded-2xl border border-outline-variant dark:border-outline-variant/30 bg-surface-container-low dark:bg-primary/5"
                >
                  ...
                  <div
                    className="text-sm text-on-surface-variant mb-4 rich-text-content"
          ...
          <div className="p-7">
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-on-surface">Ethnicity</span>
                <span className="text-sm text-on-surface-variant">
                  {profile.diversityInclusion?.ethnicity || "N/A"}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-on-surface">Pronouns</span>
                <span className="text-sm text-on-surface-variant">
                  {profile.diversityInclusion?.pronouns || "N/A"}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-on-surface">Disability Status</span>
                <span className="text-sm text-on-surface-variant">
          ...
          <div className="p-7">
            <div className="flex flex-col gap-6">
              {profile.experience.map((exp) => (
                <div
                  key={exp.id}
                  className="border-b border-outline-variant pb-4 last:border-0 last:pb-0 dark:border-outline-variant/30"
                >
                  ...
                  <div
                    className="mt-2 text-sm text-on-surface-variant rich-text-content"
          ...
          <div className="p-7">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {profile.education.map((edu) => (
                <div
                  key={edu.id}
                  className="p-5 rounded-2xl border border-outline-variant dark:border-outline-variant/30 bg-surface-container-low/50 dark:bg-primary/5"
                >
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h4 className="font-bold text-on-surface dark:text-white">
                  ...
                  {edu.description && (
                    <div
                      className="mt-2 text-sm text-on-surface-variant rich-text-content line-clamp-3"
        ...
        <form onSubmit={handleSave} className="space-y-4">
          {(modalType === "project" ||
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="mb-2 block text-sm font-medium text-on-surface dark:text-white">
                    {modalType === "project"
                      ? "Title"
                      : modalType === "experience"
                        ? "Role"
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded border border-outline-variant bg-surface-container-low py-2 px-4 focus:border-primary outline-none dark:border-outline-variant/30 dark:bg-on-surface-variant/20 text-on-surface dark:text-white"
                  />
                </div>
                <div>
                  <label className="mb-2 block text-sm font-medium text-on-surface dark:text-white">
              ...
              <div>
                ...
                <div className="bg-white dark:bg-on-surface-variant/20">
                  <ReactQuill
                    theme="snow"
                    value={description}
          ...
          {modalType === "personal" && (
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="mb-2 block text-sm font-medium text-on-surface">DOB</label>
                <input
                  type="date"
                  name="dob"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-on-surface">Gender</label>
                <select
                  name="gender"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-outline-variant dark:border-outline-variant/30">
            <button
              type="button"
              onClick={closeModal}
              className="px-6 py-2 rounded border border-outline-variant font-medium hover:shadow-1 dark:border-outline-variant/30 text-on-surface dark:text-white"
            >
              Cancel
            </button>
            <button
