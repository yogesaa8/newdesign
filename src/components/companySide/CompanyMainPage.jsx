...
const CompanyMainPage = () => {
  return (
    <div className="bg-[#f8f9ff] min-h-screen flex items-center justify-center p-6">
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
        {/* Left Side */}
        <div className="hidden lg:block space-y-8">
          <div>
            <div className="flex items-center gap-2 text-[#004ac6] font-bold mb-4">
              <span className="text-xl">RecruitPro</span>
            </div>
            <h1 className="text-5xl font-extrabold tracking-tight leading-tight">
              Scale your team with{" "}
              <span className="text-[#004ac6]">Architectural Precision.</span>
            </h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-2xl shadow-sm">
              <span className="material-symbols-outlined text-[#004ac6] text-4xl mb-3">
                groups
              </span>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1">Step 1 of 2: Company Profile</p>
          </div>
          ...
          <form className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="false"
                  className="w-full pl-12 py-3.5 bg-gray-50 border border-transparent focus:border-blue-200 rounded-2xl focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <select className="w-full pl-12 py-3.5 bg-gray-50 border border-transparent focus:border-blue-200 rounded-2xl focus:outline-none appearance-none">
            ...
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="terms"
                className="w-5 h-5 accent-[#004ac6]"
              />
              <label htmlFor="terms" className="text-sm text-gray-600">
                I agree to the{" "}
                <span className="text-[#004ac6] underline">
                  Terms of Service
                </span>{" "}
                and{" "}
                <span className="text-[#004ac6] underline">Privacy Policy</span>
              </label>
            </div>

            <button
              type="submit"
              className="w-full py-4 bg-[#004ac6] hover:bg-[#0039a1] text-white font-bold rounded-2xl flex items-center justify-center gap-2 transition-all"
            >
              Create Account
              <ArrowRight />
            </button>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link to='/company-login' className="text-[#004ac6] font-bold">
                Log in to your hub
              </Link>
            </p>
          </form>
