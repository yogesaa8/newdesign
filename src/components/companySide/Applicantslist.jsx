  ...
  return (
    <div className="flex-1">
      ...
      <div className="px-8 py-4 bg-surface border-b border-outline-variant/20">
        <div className="flex items-center gap-2 text-xs font-medium text-outline uppercase tracking-wider">
          <Link to="/company-jobs" className="hover:text-primary">Jobs</Link>
          <span>›</span>
          <Link to="/company-jobs/product-design" className="hover:text-primary">Product Design</Link>
          <span>›</span>
          <span className="text-primary font-bold">Applicants</span>
        </div>
      </div>
