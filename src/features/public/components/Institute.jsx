        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-12 lg:gap-32">
            <div className="w-full lg:col-span-6 xl:col-span-5 xl:mx-0 2xl:-mx-5">
              ...
              <h1 className="py-8 text-center font-manrope text-5xl font-bold leading-17.5 text-gray-900 lg:text-left">
                Learn With Our{" "}
              ...
              <div className="mb-8 mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row lg:justify-start">
                <Link
                  to="/institute"
                  className="w-full cursor-pointer rounded-full bg-indigo-600 px-7 py-3 text-base font-semibold text-white transition-all duration-500 hover:bg-indigo-700 md:w-fit"
                >
                  Explore Program
                </Link>
                <button
                  type="button"
                  className="w-full rounded-full border-2 border-indigo-600 bg-transparent px-7 py-3 text-base font-semibold text-indigo-600 transition-all duration-500 hover:bg-indigo-100 md:w-fit"
                >
                  Know More
                </button>
              </div>
