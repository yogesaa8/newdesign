  ...
  return (
    <div className="bg-white border border-outline-variant md:max-w-xl rounded-2xl shadow-sm p-6 flex flex-col gap-4 mb-5">
      ...
      <div>
        ...
        <p className="text-sm text-outline mt-1">{job.company}</p>
      </div>

      {/* Info Row */}
      <div className="flex flex-wrap md:max-w-106 items-center gap-6 text-sm text-outline">
  ...
  return (
    <HeroHighlight>
      <div className="px-4 sm:px-6 flex-wrap relative max-w-5xl mx-auto p-6 space-y-6  min-h-screen">
        <div className="flex justify-end text-sm text-primary cursor-pointer">
          View all
        </div>
