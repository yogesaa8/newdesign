      ...
      <section className="py-24 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center  gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="group w-full max-lg:max-w-xl lg:w-1/3 border border-outline-variant rounded-2xl">
              ...
              <div className="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-surface-container-low">
                <span className="text-primary font-medium mb-3 block">
                  Jan 01, 2023
                </span>
                <h4 className="text-xl text-on-surface font-medium leading-8 mb-5">
                  Clever ways to invest in product to organize your portfolio
                </h4>
                <p className="text-outline leading-6 mb-10">
