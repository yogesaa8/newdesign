...
export default function BlogSection() {
 ...
 Our latest <span className="">blogs</span>
 </h2>
 ...
 <button className="border rounded-full px-6 py-3 font-semibold transition">
 View All
 </button>
 </div>
 ...
 <h3 className="text-lg font-semibold mb-3 transition">
 {blog.title}
 </h3>

 <p className="text-sm mb-5">{blog.desc}</p>
 ...
 <div className="group w-full max-lg:max-w-xl lg:w-1/3 border rounded-2xl">
