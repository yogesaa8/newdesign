  ...
  return (
    <footer className="w-full bg-gradient-to-br from-sk-bg via-sk-surface to-sk-surface relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Main Footer Content */}
        <div className="py-16 flex justify-between items-center flex-col gap-10 lg:flex-row">
          {/* Logo */}
          <a
            href="/"
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset="0.993738" stopColor="#292524" />
                </linearGradient>
                <linearGradient
                ...
                >
                  ...
                  <stop offset="0.993738" stopColor="#ea580c" />
                </linearGradient>
              </defs>
            </svg>
          </a>
          ...
          <div className="flex space-x-3 sm:justify-center">
            ...
            <a
              href="https://www.linkedin.com/company/110323685/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.youtube.com/@FirstJobIndia"
              target="_blank"
              rel="noopener noreferrer"
