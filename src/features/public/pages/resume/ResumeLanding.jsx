...
const ResumeLanding = () => {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden w-full" id="home">
        {/* Background Blur */}
        <div
          aria-hidden="true"
          className="absolute inset-0 grid grid-cols-2 -space-x-20 md:-space-x-52 opacity-40 dark:opacity-20 pointer-events-none"
        >
          <div className="blur-[80px] md:blur-[106px] h-40 md:h-56 bg-linear-to-br from-primary to-purple-400 dark:from-blue-700"></div>

          <div className="blur-[80px] md:blur-[106px] h-32 bg-linear-to-r from-cyan-400 to-sky-300 dark:to-indigo-600"></div>
        </div>

        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="relative pt-28 md:pt-36 ml-auto">
            <div className="lg:w-2/3 text-center mx-auto">
              ...
              <p className="mt-8 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              ...
              <div className="mt-12 md:mt-16 flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-6">
                <a
                  href="#"
                  className="relative flex h-11 items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:before:scale-95 w-full sm:w-max"
                >
                ...
                <a
                  href="#"
                  className="relative flex h-11 items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:border before:border-transparent before:bg-primary/10 before:transition before:duration-300 hover:before:scale-105 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800 w-full sm:w-max"
                >
              ...
              {/* Stats */}
              <div className="hidden sm:flex py-8 mt-16 border-y border-gray-100 dark:border-gray-800 justify-between gap-6">
