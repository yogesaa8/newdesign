      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-slate-500">Recent Saves</p>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        {savedJobs.map((job) => (
          ...
          >
            ...
            {/* Content */}
            <div>
              <h3 className="mb-2 text-xl font-bold text-slate-900 transition group-hover:text-orange-600">
                {job.title}
              </h3>
            ...
            <div className="flex gap-3">
              <button className="flex-1 rounded border border-slate-200 py-3 font-medium text-slate-700 transition hover:bg-slate-50">
                View Details
              </button>

              <button className="flex flex-1 items-center justify-center gap-2 rounded bg-orange-500 py-3 font-semibold text-white shadow-md transition hover:bg-orange-600">
                Apply
      ...
      {savedJobs.length === 0 && (
        <div className="rounded-3xl border border-dashed border-slate-300 bg-white py-20 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-slate-100">
            <FiBookmark size={24} className="text-slate-500" />
          </div>
